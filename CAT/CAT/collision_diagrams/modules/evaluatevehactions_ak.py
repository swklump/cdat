...
def dir_act(veh_num_dir_to,veh_num_action,file_length,crash_set,i):
    ...
    if veh_num_dir_to[i] == 'north':
        ...
        elif veh_num_action[i] in ["avoiding objects in road","backing","changing lanes","entering traffic lane","leaving traffic lane",
        "making u-turn","merging","out of control","passing","parked","skidding","slowing","starting in traffic","stopped"]:
