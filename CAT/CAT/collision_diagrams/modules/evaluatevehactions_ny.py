...
def dir_act(veh_num_dir_to,veh_num_action,file_length,crash_set,i):
    ...
    elif veh_num_dir_to[i] in ['north-east']:
        if veh_num_action[i] in ["making left turn","making left turn on red"]:
    ...
    elif veh_num_dir_to[i] in ['north-west']:
        if veh_num_action[i] in ["making left turn","making left turn on red"]:
    ...
    elif veh_num_dir_to[i] in ['south-east']:
        if veh_num_action[i] in ["making left turn","making left turn on red"]:
    ...
    elif veh_num_dir_to[i] in ['south-west']:
        if veh_num_action[i] in ["making left turn","making left turn on red"]:
    ...
    for un_move in unique_movements:
        ...
        while i < len(file_length):
            if un_move == veh_movements[i]:
                ...
                if cr_severities[i] == 'fatal':
                    crash_counts[un_move][1] += 1
                elif cr_severities[i] in ['injury','property damage and injury']:
                    crash_counts[un_move][2] += 1
                elif cr_severities[i] == 'property damage':
                    crash_counts[un_move][3] += 1
                elif cr_severities[i] == 'non-reportable':
